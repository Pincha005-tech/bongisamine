...
/// Scan réception — mock `POST /traceability/reception/scan` + fraude.
...
class _ReceptionScanPageState extends State<ReceptionScanPage> {
  ...
  Future<void> _runFraudCheck() async {
    ...
    setState(() {
      _busy = false;
      _fraudResult = ReceptionMockData.simulateFraudCheck(
        batchCode: batch,
        faceMatched: _faceOk,
      );
    });
  ...
  Future<void> _submitReception() async {
    ...
    if (!mounted) return;
    final result = ReceptionMockData.simulateReceptionScan(
      batchCode: batch,
    ...
    if (result.success) {
      _snack('Lot enregistré : ${ReceptionMockData.targetStatus}');
    }
  }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Visage + QR → ${ReceptionMockData.targetStatus} '
                    '(action ${ReceptionMockData.defaultAction})',
                    style: TextStyle(
                      fontSize: 13,
              ...
              child: Material(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      LotBatchPicker(
                        batchCodes: inTransport.map((q) => q.batchCode).toList(),
                        selectedBatch: _selectedBatch,
                        dropdownHint: 'Choisir un lot en IN_TRANSPORT',
                        listEmptyMessage: 'Aucun lot en IN_TRANSPORT.',
  ...
  Widget _buildFraudCard(BuildContext context, ReceptionFraudCheckResult r) {
    final ok = r.success && !r.fraudDetected;
    return Padding(
      padding: const EdgeInsets.fromLTRB(16, 16, 16, 0),
      child: Material(
        color: ok

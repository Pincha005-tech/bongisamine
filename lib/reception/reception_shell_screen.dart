...
import 'reception_alerts_page.dart';
import 'reception_home_page.dart';
import 'reception_lots_page.dart';
import 'reception_profile_page.dart';
import 'reception_scan_page.dart';

/// Navigation superviseur réception — 5 onglets (scan-first).
...
class _ReceptionShellScreenState extends State<ReceptionShellScreen> {
  ...
  late final List<Widget> _pages = [
    ReceptionHomePage(onNavigateTab: _goTab),
    ReceptionScanPage(onNavigateTab: _goTab),
    const ReceptionLotsPage(),
    const ReceptionAlertsPage(),

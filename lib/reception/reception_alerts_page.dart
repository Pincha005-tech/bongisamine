...
class ReceptionAlertsPage extends StatefulWidget {
  const ReceptionAlertsPage({super.key});

  @override
  State<ReceptionAlertsPage> createState() => _ReceptionAlertsPageState();
}

class _ReceptionAlertsPageState extends State<ReceptionAlertsPage> {
